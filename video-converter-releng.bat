...
cls
echo.
echo       video-converter-releng menu
REM echo       usage: video-converter-releng.bat [start|stop|{target}]
echo.
...
echo to stop the server, run this again or run: video-converter-releng.bat stop
goto end
::
:stopServer
